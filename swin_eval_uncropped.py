...
tokenizer = AutoFeatureExtractor.from_pretrained("swin_uncropped_out/GLAUCOMASWINUNCROPPED/10_2023-10-30-21-29-17/feature_extractor")
model = SwinForImageClassification.from_pretrained("swin_uncropped_out/GLAUCOMASWINUNCROPPED/10_2023-10-30-21-29-17/model")
